...
echo;
flatpak remote-add --if-not-exists flathub https://flathub.org/repo/flathub.flatpakrepo && flatpak install notepadqq visualstudio.code darktable krita gpuviewer antimicrox firmware pupgui2 videodownloader net.veloren.airshipper -y;
echo;
