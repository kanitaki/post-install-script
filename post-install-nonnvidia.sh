...
echo "sleep 1 && nitrogen --restore &" >> ~/.config/openbox/autostart && echo "exec dunst &" >> ~/.config/openbox/autostart && echo "exec synapse &" >> ~/.config/openbox/autostart && echo "bash ~/.config/polybar/launch.sh --forest &" >> ~/.config/openbox/autostart && echo "xfsettingsd &" >> ~/.config/openbox/autostart && echo "xscreensaver &" >> ~/.config/openbox/autostart;
echo;
