...
echo;
sudo dnf install slick-greeter xfce4-settings lightdm-gtk-greeter-settings cantata dunst picom rofi network-manager-applet papirus-icon-theme kde-connect nitrogen xscreensaver synapse polybar vim gvim tilix pcmanfm xbacklight xrandr openbox obconf dnfdragora -yq;
echo;
...
echo;
mkdir ~/.config/openbox && touch ~/.config/openbox/autostart && echo "sleep 1 && nitrogen --restore &" >> ~/.config/openbox/autostart && echo "exec dunst &" >> ~/.config/openbox/autostart && echo "exec synapse &" >> ~/.config/openbox/autostart && echo "bash ~/.config/polybar/launch.sh --forest &" >> ~/.config/openbox/autostart && echo "xfsettingsd &" >> ~/.config/openbox/autostart && echo "xscreensaver &" >> ~/.config/openbox/autostart;
echo;
